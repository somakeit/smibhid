...
CONFIG_SECTIONS = {
    "Logging": {"LOG_LEVEL": LOG_LEVEL, "LOG_HANDLERS": LOG_HANDLERS, "LOG_FILE_MAX_SIZE": LOG_FILE_MAX_SIZE},
    "IO": {"SPACE_OPEN_BUTTON": SPACE_OPEN_BUTTON, "SPACE_CLOSED_BUTTON": SPACE_CLOSED_BUTTON, "SPACE_OPEN_LED": SPACE_OPEN_LED, "SPACE_CLOSED_LED": SPACE_CLOSED_LED, "SPACE_OPEN_RELAY": SPACE_OPEN_RELAY, "SPACE_OPEN_RELAY_ACTIVE_HIGH": SPACE_OPEN_RELAY_ACTIVE_HIGH},
    "WIFI": {"WIFI_SSID": WIFI_SSID, "WIFI_PASSWORD": WIFI_PASSWORD, "WIFI_COUNTRY": WIFI_COUNTRY, "WIFI_CONNECT_TIMEOUT_SECONDS": WIFI_CONNECT_TIMEOUT_SECONDS, "WIFI_CONNECT_RETRIES": WIFI_CONNECT_RETRIES, "WIFI_RETRY_BACKOFF_SECONDS": WIFI_RETRY_BACKOFF_SECONDS, "CUSTOM_HOSTNAME": CUSTOM_HOSTNAME},
    "NTP": {"NTP_SYNC_INTERVAL_SECONDS": NTP_SYNC_INTERVAL_SECONDS},
    "Web": {"WEBSERVER_HOST": WEBSERVER_HOST, "WEBSERVER_PORT": WEBSERVER_PORT},
    "Space": {"SPACE_STATE_POLL_PERIOD_S": SPACE_STATE_POLL_PERIOD_S, "ADD_HOURS_INPUT_TIMEOUT": ADD_HOURS_INPUT_TIMEOUT},
    "I2C": {"SDA_PIN": SDA_PIN, "SCL_PIN": SCL_PIN, "I2C_ID": I2C_ID, "I2C_FREQ": I2C_FREQ},
    "Sensors": {"SENSOR_MODULES": SENSOR_MODULES, "DEFAULT_CO2_CALIBRATION_VALUE": DEFAULT_CO2_CALIBRATION_VALUE},
    "Displays": {"DISPLAY_DRIVERS": DISPLAY_DRIVERS, "SCROLL_SPEED": SCROLL_SPEED},
    "RFID": {"RFID_ENABLED": RFID_ENABLED, "RFID_SCK": RFID_SCK, "RFID_MOSI": RFID_MOSI, "RFID_MISO": RFID_MISO, "RFID_RST": RFID_RST, "RFID_CS": RFID_CS},
    "Overclocking": {"CLOCK_FREQUENCY": CLOCK_FREQUENCY},
}